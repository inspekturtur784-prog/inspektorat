...
class GaleriController extends Controller
{
    ...
    {
        return view('admin.galeri.create', ['kategoriList' => Galeri::KATEGORI]);
    }
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'kategori'  => 'required|in:' . implode(',', Galeri::KATEGORI),
    ...
    {
        return view('admin.galeri.edit', ['galeri' => $galeri, 'kategoriList' => Galeri::KATEGORI]);
    }
