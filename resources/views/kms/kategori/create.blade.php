...
<style>
    ...
    .kp-field input, .kp-field textarea, .kp-field select { width:100%; padding:10px 12px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box; }
...
<div class="kp-wrap">
    <div class="kp-header"><h1>Tambah Kategori KMS</h1></div>
