...
<div class="dash-stats">
    <a href="{{ route('admin.articles.index') }}" class="dash-stat-card dash-c-blue">
    ...
    <a href="{{ route('admin.pegawai.index') }}" class="dash-stat-card dash-c-green">
        <span class="dash-stat-icon">
    ...
    <a href="{{ route('admin.galeri.index') }}" class="dash-stat-card dash-c-purple">
        <span class="dash-stat-icon">
    ...
    <a href="{{ route('admin.struktur.index') }}" class="dash-stat-card dash-c-orange">
        <span class="dash-stat-icon">
    ...
    <a href="{{ route('admin.tugasfungsi.index') }}" class="dash-stat-card dash-c-teal">
        <span class="dash-stat-icon">
    ...
    <a href="{{ route('admin.pesan.index') }}" class="dash-stat-card {{ $stats['pesan'] > 0 ? 'dash-c-red' : 'dash-c-slate' }}">
        <span class="dash-stat-icon">
    ...
    <a href="{{ route('admin.buletin.index') }}" class="dash-stat-card dash-c-gold">
        <span class="dash-stat-icon">
