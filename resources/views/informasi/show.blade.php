    ...
    @else
        ...
        <ol class="info-list" style="counter-reset: item;">
            @foreach ($items as $item)
                <li>
                    <span class="info-num">{{ $loop->iteration }}</span>
                    @if ($item->file_url)
                        <a href="{{ $item->file_url }}" class="info-title" target="_blank">
                            {{ $item->judul }}
                            @if ($item->keterangan)
                                <span class="info-desc">{{ $item->keterangan }}</span>
                            @endif
                        </a>
                    @else
                        <span class="info-title" style="cursor: default;">
                            {{ $item->judul }}
                            @if ($item->keterangan)
                                <span class="info-desc">{{ $item->keterangan }}</span>
                            @endif
