...
// PENTING: cuma ada SATU baris untuk /layanan/buletin, dan dia redirect
// ke halaman buletin yang asli (/buletin) — bukan halaman "coming soon".
Route::redirect('/layanan/buletin', '/buletin', 301);
Route::view('/layanan/skm', 'coming-soon', ['title' => 'SKM Inspektorat']);

// /berita sudah pakai BeritaController asli (bukan lagi halaman coming-soon)
...
// (mencegah error "Route [login] not defined" saat middleware auth
// menolak akses dan mengarahkan user ke route bernama 'login')
